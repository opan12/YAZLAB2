    ...
    public partial class Inialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IlgiAlanları", x => x.KullanıcıId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Katilimcis", x => new { x.KullanıcıId, x.EtkinlikID });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MesajID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GondericiID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EtkinlikId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Puanlar", x => x.KullaniciID);
                });
